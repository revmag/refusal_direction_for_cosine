...
def get_mean_activations_for_harmful(
    model,
    tokenizer,
    instructions,
    tokenize_instructions_fn,
...
def get_activation_for_harmful(
    model,
    tokenizer,
    harmful_instructions,
    tokenize_instructions_fn,
    ...
    mean_activations_harmful = get_mean_activations_for_harmful(
        model,
        tokenizer,
        harmful_instructions,
        tokenize_instructions_fn,
...
def generate_activations_for_harmful(model_base: ModelBase, harmful_instructions):
    ...
    assert not mean_activations.isnan().any()
